import { addFriendAPI, loginAPI, loginWithCookieAPI, logoutApi, removeFriendAPI, resetPasswordApi, signupAPI } from "../apiUtils";
...
export const signUpActionCreator = ()=>{
    return asyncActionCreator(ACTIONS.SIGNUP,signupAPI)
}
